...
CREATE TABLE `student_tbl` (
  ...
  `courses_enrolled_no` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_f1whjydf7v506s60le3bdtssw` (`email`)
...
INSERT INTO `student_tbl` VALUES (3,'cw@123','Chris pratt','cw123','1'),(4,'ved@gmail.com','ved','abc123','1');
