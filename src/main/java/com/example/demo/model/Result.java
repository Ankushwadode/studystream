...
public class Result {
	...
	public Result(String username, String subject, int score, int totalCorrect, int totalIncorrect) {
		super();
		this.username = username;
		this.subject = subject;
		this.score = score;
	...
	public Result(int id, String username, String subject, int score, int totalCorrect, int totalIncorrect) {
		super();
		this.id = id;
		this.username = username;
		this.subject = subject;
